...
import Flip from "../../../elements/Dashboard/Flip";
      ...
      <div className="_flipper">
        ...
        <div className=" py-4 px-7 rounded-2xl bg-[#E1DFA4] _back">
          <Image
            ...
            alt=""
          />
          <span className="ml-3 text-base font-bold">111% Recommend</span>
          <Image
            width={257}
            height={106}
            src="/img/dashboard/mini-cooper.png"
            alt="Mini Cooper"
          />
          <h3 className="text-xl font-bold text-[#162731]">Mini Cooper2</h3>
          <div className="mt-2 flex gap-4 items-center">
            <Flip />
            <Image
              width={26}
      ...
      <div className="_flipper">
        ...
        <div className="w-full py-4 px-7 rounded-2xl bg-[#E3ECF1] _back">
          ...
          <Image
            ...
            alt="Maruti Suzuki"
          />
          <h3 className="text-xl font-bold text-[#162731]">Maruti Suzuki2</h3>
          <div className="mt-2 flex items-center gap-4">
            <Flip />
            <Image
              width={26}
      ...
      <div className="_flipper">
        ...
        <div className="w-full py-4 px-7 rounded-2xl bg-[#F4E3E5] _back">
          ...
          <Image
            ...
            alt="suzukiSwift"
          />
          <h3 className="text-xl font-bold text-[#162731]">Suzuki Swift2</h3>
          <div className="mt-2 flex items-center gap-4">
            <Flip />
            <Image
              width={26}
